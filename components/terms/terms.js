  ...
  render() {
    return (
      <div className="legal">
        ...
        <p>
          This page states the Terms and Conditions under which users / visitor
          may visit this site. Please read this page carefully. If you do not
          accept the Terms and Conditions stated here, we would request you to
          exit this site. The business, any of its business divisions and/or its
        ...
        <p>
          All logos, brands, marks headings, labels, names, images, signatures,
          ...
          this site. The use of these properties or any other content on this
        ...
        <p>
          Users / Visitors are prohibited from violating or attempting to
        ...
        <p>
          ...
          "Trojan horse" to the Website, overloading, "flooding", "mailbombing"
          or "crashing", or
        </p>
        <p>
          (4) sending unsolicited electronic mail, including promotions and/or
          ...
          and/or it's associate entities will have the right to investigate
        ...
        <p>
          Users / Visitors may not use the Website in order to transmit,
        ...
        <p>
          ...
          secret or other intellectual property rights of others or violate the
          privacy or publicity of other personal rights of others, or
        </p>
        <p>
        ...
        <p>
          ...
          their use of www.clicktridot.com or their breach of the terms.
        </p>
        <h4>LIABILITY</h4>
        <p>
